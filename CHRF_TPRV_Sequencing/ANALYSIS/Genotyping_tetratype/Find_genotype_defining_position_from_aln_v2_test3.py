...
def parse_args():
	...
	commands = ArgumentParser(description='Find genotype specific allele position from SNP alignment.')
...
clades = ["0", "1", "2", "0.1", "1.0", "1.1", "1.2", "2.0", "2.1", "2.2", "2.3", "2.4", "1.2.1", "1.2.2", "2.0.1", "2.3.1", "2.3.2", "2.3.3", "2.3.4", "2.3.X", "2.4.1", "2.4.2", "2.4.3", "2.4.4", "2.4.5", "2.4.a", "2.4.d", "2.4.e", "2.4.f"]

#target_clades = ["2", "1.0", "2.2"]
...
print('Clade\tNo_Uniq_Allele\tNo_Uniq_allele_CDS\tNo_Uniq_allele_mlst')
...
for i in range(0, len(clades)):
	...
	print("%s\t%i\t%i\t%i" % (str(clades[i]), len(geno_uniq), len(geno_specific_POS_cds), len(geno_specific_POS_mlst)))
